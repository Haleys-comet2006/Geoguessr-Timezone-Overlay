/* @ts-self-types="./tzf_wasm.d.ts" */

export class WasmFinder {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmFinderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmfinder_free(ptr, 0);
    }
    /**
     * @returns {string}
     */
    data_version() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmfinder_data_version(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_tz_name(lng, lat) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmfinder_get_tz_name(this.__wbg_ptr, lng, lat);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_tz_names(lng, lat) {
        const ret = wasm.wasmfinder_get_tz_names(this.__wbg_ptr, lng, lat);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./tzf_wasm_bg.js": import0,
    };
}

const WasmFinderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmfinder_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tzf_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
